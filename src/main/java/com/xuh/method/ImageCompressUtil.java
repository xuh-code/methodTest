...
public class ImageCompressUtil {
    ...
    public static String zipImageFile(String oldFile, int width, int height,
        ...
        try {
            ...
            /** 压缩后的文件名 */
            newImage = "E:/"	+ "2X" + oldFile.substring(filePrex.length()+1);
            /** 压缩之后临时存放位置 */
            ...
            //ImageCompressUtil.saveMinPhoto(newImage, newImage, 1920, 0.9d);
    ...
    public static void main(String args[]) throws Exception {
        ...
        //ImageCompressUtil.zipImageFile("E:\\flute.jpg", 1920, 952, 1f, "x2");
        ImageCompressUtil.saveMinPhoto("E:\\2Xflute.jpg",
                "E:\\x2music-1.jpg", 1080, 0.9d);
