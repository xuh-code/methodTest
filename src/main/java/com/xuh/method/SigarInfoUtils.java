...
/**
 * 获取系统信息
 * Created by xuh on 2017/4/6.
 */

public class SigarInfoUtils {
     ...
     */
    public static long getDiskTotal(String disk){
     ...
     * @throws SigarException
     */
    public static long getDiskSurplus(String disk){
        Sigar sigar = new Sigar();
        long surplus = 0;
        FileSystem fslist[] = new FileSystem[0];
        try {
        ...
        for (int i = 0; i < fslist.length; i++) {
            ...
            switch (fs.getType()) {
                case 2:
                    ...
                    if (disk.equals(fs.getDirName())) {
                        surplus = usage.getFree()/1024/1024;
                    }
                    break;
            }
        }
